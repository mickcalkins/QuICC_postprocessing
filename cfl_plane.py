...
f = open("cfl_data.txt", "w")
f.write("CFL-based timestep sizes:\n")
f.write("dt_x, dt_y, dt_z:")
f.write(' ')
f.write('{:.2e}'.format(dt_x_min))
f.write(', ')
f.write('{:.2e}'.format(dt_y_min))
f.write(', ')
f.write('{:.2e}'.format(dt_z_min))
f.close()
