...
# open files
f1 = open('vorticityx_rms.dat', 'r')
f2 = open('vorticityy_rms.dat', 'r')
f3 = open('vorticityz_rms.dat', 'r')
...
print('Viscous dissipation rate = ', enstrophy_int)
